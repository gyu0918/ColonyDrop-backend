...
//                .withClaim("memberName", principalDetails.getMember().getMemberName()) //닉네임 추가용
                ...
                .withClaim("roles", principalDetails.getMember().getRoles()) // ← 이거 추가
                .withExpiresAt(new Date(System.currentTimeMillis() + jwtProperties.getExpirationTime()))
                .sign(Algorithm.HMAC512(jwtProperties.getSecret()));

        //
        //refresh Token 생성 부분package com.example.colonydrop.config.security.handler;
        //
        //
        //import com.auth0.jwt.JWT;
        //import com.auth0.jwt.algorithms.Algorithm;
        ...
        //                .sameSite("None")  //  sameSite 설정을 해줘야지 csrf보안 처리를 안할수 있고  // ✅ 팝업 크로스 도메인
        ////                .sameSite("None")
        ...
        //
        //
        //        // ✅ accessToken이 있으면 저장 (카카오 only)  카카오톡 초대하기 떄문에 넣는건데 초대하기 안쓸거면 삭제
