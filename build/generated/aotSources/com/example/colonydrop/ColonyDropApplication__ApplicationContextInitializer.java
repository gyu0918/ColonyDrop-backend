 ...
 */
@Generated
public class ColonyDropApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new ColonyDropApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new ColonyDropApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "com.example.colonydrop.config.security.config.SecurityConfig");
    mappings.put("org.springframework.session.data.redis.config.annotation.web.http.RedisHttpSessionConfiguration", "org.springframework.boot.session.data.redis.autoconfigure.SessionDataRedisAutoConfiguration$ServletRedisSessionConfiguration$DefaultRedisSessionConfiguration");
