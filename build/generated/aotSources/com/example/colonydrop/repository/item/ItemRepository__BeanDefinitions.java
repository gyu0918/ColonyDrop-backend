...
/**
 * Bean definitions for {@link ItemRepository}.
 */
@Generated
public class ItemRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'itemRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getItemRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'itemRepository'.
   */
  public static BeanDefinition getItemRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ItemRepository.class, Item.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.example.colonydrop.repository.item.ItemRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.ItemRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.example.colonydrop.repository.item.ItemRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getItemRepositoryInstanceSupplier();
